...
A poll has a question, an array of options from which people can choose, and an array
 with the number of replies for each option. 
...
The method takes a string as an input (called 'type'), which can be either 'string' or 
'array'. 
...
const registerNewAnswer = function () {
  ...
  if (answer < 4 && answer >= 0) {
    ...
    console.log(' values : 0: JavaScript 1: Python 2: Rust 3: C++');
  }
};
...
the color of the selected h1 element ('header') to blue, 
...
you need. Think about WHEN exactly the callback function is executed, 
